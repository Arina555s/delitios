(() => {
    ...
    (() => {
        ...
        const picker = datepicker_min("[data-datepicker]", {
            ...
            disabledDates: [ new Date(2022, 5, 5), new Date(2022, 5, 6), new Date(2022, 5, 7), new Date(2022, 5, 15), new Date(2022, 5, 25) ]
        });
        ...
        function initSliders() {
            if (document.querySelector(".slider-first")) new core(".slider-first__slider", {
                ...
                speed: 800,
                pagination: {
                    el: ".slider-first-scrollbar",
                    clickable: true
                },
                navigation: {
                    prevEl: ".slider-first-button-prev",
                    nextEl: ".slider-first-button-next"
                },
                on: {}
            });
            if (document.querySelector(".column-add__top")) new core(".column-add__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".column-add__bottom")) new core(".cell-add__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 3,
            ...
            if (document.querySelector(".advertising")) new core(".advertising__slider", {
                modules: [ Pagination ],
                observer: true,
                observeParents: true,
                slidesPerView: 4,
        ...
        window.onload = function() {
            ...
            function documentActions(e) {
                ...
                if (targetElement.classList.contains("cart-header__shop") || targetElement.closest(".cart-header__shop")) {
                    if (document.querySelector(".cart-list").children.length > 0) document.querySelector(".cart-header").classList.toggle("_active");
                    e.preventDefault();
                } else if (!targetElement.closest(".cart-header") && !targetElement.classList.contains("card-product__btn")) document.querySelector(".cart-header").classList.remove("_active");
            ...
            function addToCart(productButton, productId) {
                if (!productButton.classList.contains("_hold")) {
                    ...
                    productButton.classList.add("_flys");
                    const cart = document.querySelector(".cart-header__shop");
                    const product = document.querySelector(`[data-pid="${productId}"]`);
                    const productImage = product.querySelector(".card-product__img");
                    ...
                    productImageFly.addEventListener("transitionend", (function() {
                        if (productButton.classList.contains("_flys")) {
                            productImageFly.remove();
                            updateCart(productButton, productId);
                            productButton.classList.remove("_flys");
                        }
                    }));
                }
            }
            function updateCart(productButton, productId, productAdd = true) {
                ...
                const cartIcon = cart.querySelector(".cart-header__shop");
                ...
                if (productAdd) {
                    ...
                    if (!cartProduct) {
                        const product = document.querySelector(`[data-pid="${productId}"]`);
                        const cartProductImage = product.querySelector(".card-product__img").innerHTML;
                        const cartProductTitle = product.querySelector(".card-product__title").innerHTML;
